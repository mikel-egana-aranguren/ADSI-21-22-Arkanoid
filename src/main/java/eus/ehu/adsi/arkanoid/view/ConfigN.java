...
public abstract class ConfigN {
	...
	public static final double BALL_VELOCITY1 = 0.1;
	public static final double BALL_VELOCITY2 = 0.3;
	public static final double BALL_VELOCITY3 = 0.5;
	...
	public static final int COUNT_BLOCKS_Y1 = 4;
	public static final int COUNT_BLOCKS_X2 = 11;
	public static final int COUNT_BLOCKS_Y2 = 5;
	public static final int COUNT_BLOCKS_X3 = 11;
	public static final int COUNT_BLOCKS_Y3 = 6;
